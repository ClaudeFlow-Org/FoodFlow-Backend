...
public class TopDish {
    ...
    public TopDish(Long dishId, String dishName, Integer quantitySold, BigDecimal totalRevenue) {
        this.dishId = dishId;
    ...
    public static class Builder {
        ...
        public TopDish build() {
            return new TopDish(dishId, dishName, quantitySold, totalRevenue);
        }
    }
}
